...
saymanlık_listesi <- read.xlsx("Desktop/Projeler (okul dışı)/hmb/hmbdat.xlsx", sheet = 1)
veri <- read.xlsx("Desktop/Projeler (okul dışı)/hmb/saymalık_listesi.xlsx", sheet = 1, startRow = 2)
